...
async function main() {
  //Proxy Address
  const proxyAddress = contractAddr.history;
  //Validate
  ...
  //Log
  console.log("Update OpenRepo Proxy:");

  //Fetch New Implementation Contract
  let NewImplementation = await ethers.getContractFactory("OpenRepoUpgradable");
  ...
  //Log
  console.log("OpenRepoUpgradable Contract Updated");
}
